...
//This is a changed Line OR IT NEEDS TO BE BECUASE I CANT USE GPIO PORT B FOR FINAL, will need to mess around with this code but going to keep it GPIO B until I know what ports avaialable
...
{
    lcddev.reg_select(0);
    SPI->CR1 |= SPI_CR1_DFF;  //This is a changed Line <---------------------------
}
...
void LCD_WriteData16_End()
{
    SPI->CR1 &= ~SPI_CR1_DFF; // bad value forces it back to 8-bit mode   //This is a changed Line <---------------------------
}
#endif /* not SLOW_SPI */
